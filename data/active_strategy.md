...
- IMAP check before EVERY send — 49-day gap is an operational and compliance risk
...
## BATCH 5 RYEDALE — CURRENT STATUS (Week 9, Day 11)
...
**Batch 6 — scoping deferred to Wednesday 2026-05-27:**
- **Trigger deferred:** 0 confirmed replies, last trigger window (Friday 2026-05-22) passed — IMAP unconfirmed
...
- **Decision date:** Wednesday 2026-05-27 BRAIN run (Batch 5 post-mortem)
- **Expected start:** Data collection from Wednesday 2026-05-27. Initial sends: Tuesday 2026-06-02.
- **LinkedIn:** MUST activate within Day 3-7. Archive trigger: Day 7 (Tuesday 2026-06-09) fires unconditionally if profiles.json missing.
...
- IMAP check before every send — 49-day gap is a compliance risk
