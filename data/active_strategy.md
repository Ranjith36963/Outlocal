...
**Updated:** 2026-05-31 (Day 65 Sunday — Week 10 Close — Batch 5 FORMALLY CLOSED — batch_6_leads.json STILL MISSING — Emergency Final Deadline TODAY EOD)  
**Replaces:** 2026-05-30 strategy (Day 64 — Saturday — Weekend Bridge — Batch 5 Formally Closed)  
**Valid until:** 2026-06-09 (after Batch 6 Day-0 send confirmed — Scenario A: Tue 2026-06-02 / Scenario B: Tue 2026-06-09)  
**Weekly report:** data/weekly_reports/week_2026-05-31.md (WEEK 10 CLOSE — generated this run)

---

## CURRENT CAMPAIGN STATUS

- **Week:** 10 close (live since 28 March 2026 — 65 days)
- **Batch 5 Ryedale:** **FORMALLY CLOSED — 2026-05-29 evening.** Post-Day-14 72h window closed Friday evening. 0 confirmed replies across full 4-touchpoint sequence. Reapproach: 2026-11-26. No further IMAP, no further sends.
- **Batch 6 Harrogate + Craven:** **LAUNCH CONFIRMED.** batch_6_leads.json STILL MISSING — **65-session HANDS pattern**. **EMERGENCY FINAL DEADLINE: TODAY SUNDAY 2026-05-31 EOD — ABSOLUTELY FINAL.** Scenario A: Day-0 Tue 2026-06-02 (if received tonight + BRAIN Monday copy). Scenario B: Day-0 Tue 2026-06-09 (if not — HIGH PROBABILITY given 65-session pattern).
...
- **LinkedIn:** **PERMANENTLY CLOSED for Batch 5 and all prior leads — archive trigger fired 2026-05-19 EOD (65-session failure). MANDATORY for Batch 6: activate Day 3-7 from Day-0. Archive trigger Day 7 from Day-0 — unconditional.**
- **IMAP gap:** **57 days** from confirmed check (2026-04-04). NOT REQUIRED today (Sunday block, Batch 5 window closed). Next IMAP obligation: Batch 6 leads only (per lead before each Day-0 send).
- **CHANGELOG:** **63+ days overdue — MANDATORY — earliest available session — ABSOLUTE FINAL TOLERANCE.**
- **Weekly intelligence report:** data/weekly_reports/week_2026-05-31.md (WEEK 10 CLOSE — generated this run)
...
## FRAMEWORK ALLOCATION — WEEK 10-11
...
- IMAP check before EVERY send — 56-day gap is an operational and compliance risk — weekly IMAP mandatory for Batch 6
...
| **Batch 6 Day-0 Scenario A** | **TUESDAY 2026-06-02, 09:00-10:30** (if batch_6_leads.json received Sunday EOD) |
| **Batch 6 Day-0 Scenario B** | **TUESDAY 2026-06-09, 09:00-10:30** (if batch_6_leads.json not received Sunday EOD) |
...
**Model assessment:** SOUND. 0% Batch 5 = execution failure (56-day IMAP gap + 64-session LinkedIn failure + no per-lead data file). SSL-PAS 15% INTERESTED rate remains non-negotiable for Batch 6.

---

## BATCH 6 HARROGATE + CRAVEN — LAUNCH CONFIRMED (TWO-SCENARIO STATUS)
...
**batch_6_leads.json:** MISSING — EMERGENCY FINAL DEADLINE TODAY SUNDAY 2026-05-31 EOD — ABSOLUTELY FINAL (65-session HANDS failure pattern)  
**Note:** Scenario A still technically open until tonight EOD. Scenario B is HIGH PROBABILITY given 65-session pattern.

| Scenario | Condition | Day-0 | Day-3 + LinkedIn | Day-7 | LinkedIn Trigger | Day-14 |
|---|---|---|---|---|---|---|
| **A** | File received TODAY Sun EOD + BRAIN Monday copy | **Tue 2026-06-02** | **Fri 2026-06-05** | Tue 2026-06-09 | **Tue 2026-06-10 EOD** | Tue 2026-06-16 |
| **B** | File NOT received by Mon morning BRAIN run (HIGH PROBABILITY) | Tue 2026-06-09 | Fri 2026-06-12 | Tue 2026-06-16 | Tue 2026-06-17 EOD | Tue 2026-06-23 |

**LinkedIn rules (MANDATORY both scenarios):**
...
## LINKEDIN CHANNEL RULES — WEEK 10

**STATUS FOR BATCH 5 AND ALL PRIOR: PERMANENTLY CLOSED — archive trigger fired Tuesday 2026-05-19 EOD (64-session failure).**
...
- **Day-0:** Scenario A Tue 2026-06-02 / Scenario B Tue 2026-06-09
...
- IMAP check before every send — 56-day gap is a compliance risk — weekly IMAP mandatory for Batch 6
- 4-touchpoint maximum — hard limit, no exceptions
- LinkedIn: do not approach leads who replied NOT_INTERESTED on any channel

---

## OPERATIONAL PRIORITIES — WEEK 11 (Days 65-72, 2026-05-31 to 2026-06-06)

| Priority | Action | Deadline | Status |
|---|---|---|---|
| **1** | **batch_6_leads.json** — 18-22 leads, Harrogate + Craven | **TODAY SUNDAY 2026-05-31 EOD — ABSOLUTELY FINAL** | MISSING — 65-SESSION FAILURE |
| **2** | **CHANGELOG.md** — 63+ days overdue | **Monday 2026-06-01 — ABSOLUTE FINAL TOLERANCE** | OVERDUE |
| **3** | **BRAIN signal assignment + email copy** — read batch_6_leads.json, assign signals, per-lead copy | **Monday 2026-06-01** (only if file received tonight) | Upcoming |
| **4** | **Update lead status → sequence_complete** — all Batch 5 Ryedale leads. Reapproach: 2026-11-26. | Monday | DUE |
| **5** | **Batch 6 Day-0 sends** — IMAP per lead before each | **Tue 2026-06-02 (A) or Tue 2026-06-09 (B)** | Upcoming |
| **6** | **Batch 6 Day-3 bumps + LinkedIn** — profiles.json SAME SESSION | **Fri 2026-06-05 (A) or Fri 2026-06-12 (B)** | Upcoming |
| **7** | **LinkedIn archive trigger** — fires unconditionally | **Tue 2026-06-10 EOD (A) or Tue 2026-06-17 EOD (B)** | Upcoming |
| **8** | **Batch 6 Day-7 new angle** | **Tue 2026-06-09 (A) or Tue 2026-06-16 (B)** | Upcoming |
| **9** | **Batch 6 Day-14 breakup** | **Tue 2026-06-16 (A) or Tue 2026-06-23 (B)** | Upcoming |
...
*Updated: 2026-05-31 (Day 65 — Sunday — Week 10 Close — Batch 5 Formally Closed — batch_6_leads.json EMERGENCY FINAL DEADLINE TODAY EOD).*  
*HANDS layer agents must read this file before starting any daily run.*  
*Next BRAIN review: Monday 2026-06-01 — reads batch_6_leads.json IF received tonight → per-lead signal assignments + email copy → Tue 2026-06-02 Day-0 (Scenario A) OR generates Scenario B deferred copy if file still missing. If INTERESTED reply ever discovered incidentally: 24h proposal SLA applies (24/7 — NON-NEGOTIABLE). Use value_delivery_queue.json directly.*
